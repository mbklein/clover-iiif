...
import "@iiif/helpers";
import g, { Component as He, createElement as fe, createContext as Ze, useCallback as _e, useEffect as V, useState as se, useRef as Je } from "./react-shim.mjs";
      ...
      for (d in v) {
        ...
        for (p of _) {
          ...
          if (x && (R = d.slice(1) in n.media ? "@media " + n.media[d.slice(1)] : d, d = R.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (y, $, P, f, w, T) => {
            const M = de.test($), O = 0.0625 * (M ? -1 : 1), [F, X] = M ? [f, $] : [$, f];
...
}, { styled: W, css: ts, keyframes: os, createTheme: ns } = Et({
  theme: Lt,
  media: Mt
}), zt = W("div", {
  display: "flex",
...
}, Ao = "Cerrar", Eo = "Siguiente", Lo = "Abrir", Mo = "Anterior", zo = "Buscar", Oo = "Buscar...", No = "Compartir", jo = "Ver todo", Wo = "Fallido", Fo = "Copiado", Vo = "Cargando...", Do = "Buscar", Ho = "Sin resultados", Zo = "Más resultados", _o = "Pantalla completa", Jo = "Restablecer zoom", Uo = "Girar a la izquierda", Ko = "Girar a la derecha", Go = "Acercar", Xo = "Alejar", qo = "Seleccionar", Yo = "Visor", Qo = "Acerca de", en = "Anotaciones", tn = "Buscar", on = "Más información", nn = "Ver colección", rn = "Copiar URL de la colección", sn = "Ver manifiesto", an = "Copiar URL del manifiesto", cn = {
  commonClose: Ao,
  commonNext: Eo,
  commonOpen: Lo,
  commonPrevious: Mo,
...
}, Mr = "Lukk", zr = "Neste", Or = "Førre", Nr = "Søk", jr = "Søk...", Wr = "Del", Fr = "Sjå alle", Vr = "Feila", Dr = "Kopiert", Hr = "Laster inn...", Zr = "Søk", _r = "Ingen resultat", Jr = "Fleire resultat", Ur = "Vel", Kr = "Viewer", Gr = "Om", Xr = "Annoteringa", qr = "Søk", Yr = "Meir informasjon", Qr = "Sjå samlinga", ei = "Kopiér samlingas URL", ti = "Sjå manifestet", oi = "Kopiér manifestets URL", ni = {
  commonClose: Mr,
  commonNext: zr,
  commonPrevious: Or,
  commonSearch: Nr,
...
const Ni = () => /* @__PURE__ */ g.createElement(
...
), Fi = () => /* @__PURE__ */ g.createElement("path", { d: "M448 440a16 16 0 01-12.61-6.15c-22.86-29.27-44.07-51.86-73.32-67C335 352.88 301 345.59 256 344.23V424a16 16 0 01-27 11.57l-176-168a16 16 0 010-23.14l176-168A16 16 0 01256 88v80.36c74.14 3.41 129.38 30.91 164.35 81.87C449.32 292.44 464 350.9 464 424a16 16 0 01-16 16z" }), ke = () => /* @__PURE__ */ g.createElement(g.Fragment, null, /* @__PURE__ */ g.createElement(
  "path",
  {
    fill: "none",
    strokeLinecap: "round",
...
), /* @__PURE__ */ g.createElement("path", { d: "M464 97.42V208a16 16 0 01-16 16H337.42c-14.26 0-21.4-17.23-11.32-27.31L436.69 86.1C446.77 76 464 83.16 464 97.42z" })), Vi = ({
  ...
  return V(() => {
    ...
    t.showFullPageControl && /* @__PURE__ */ g.createElement(
      ...
      /* @__PURE__ */ g.createElement(Wi, null)
    ),
    ...
    t.showHomeControl && /* @__PURE__ */ g.createElement(U, { id: t.homeButton, label: o("imageResetZoom") }, /* @__PURE__ */ g.createElement(Fi, null)),
    u()
  );
};
...
const Di = (e) => new Promise((t) => setTimeout(t, e)), Te = async (e, t, o = 3, n = 300) => {
  ...
  V(() => (R.current || (R.current = !0, s || d(oe(o))), () => s == null ? void 0 : s.destroy()), []), V(() => {
    _();
  }, [s, c]), V(() => {
    ...
    e && (s == null || s.clearOverlays(), e.forEach((I) => {
      var O, F, X, ie;
      const { annotation: y, targetIndex: $ } = I, P = ((F = (O = s == null ? void 0 : s.viewport) == null ? void 0 : O.getBounds()) == null ? void 0 : F.width) || 1, f = s == null ? void 0 : s.world.getItemAt($), w = f ? (f == null ? void 0 : f.getBounds().width) / (f == null ? void 0 : f.getContentSize().x) : ((X = p[$]) == null ? void 0 : X.width) / P, T = qe(
        y == null ? void 0 : y.target
      ), M = y != null && y.body ? (ie = y == null ? void 0 : y.body[0]) == null ? void 0 : ie.value : void 0;
      if (T != null && T.rect) {
        const { x: q, y: Y, w: We, h: Fe } = T == null ? void 0 : T.rect, Ve = A(q, $, w), Q = new oe.Rect(
          Ve,
          Y * w,
          We * w,
          Fe * w
