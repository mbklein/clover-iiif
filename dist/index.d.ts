...
import { Annotation, AnnotationNormalized, AnnotationPageNormalized, AnnotationTarget, CanvasNormalized, Collection, CollectionNormalized, IIIFExternalWebResource, InternationalString, Manifest, ManifestNormalized, MetadataItem, Reference } from '@iiif/presentation-3';
import { IncomingHttpHeaders } from 'http';
import OpenSeadragon from 'openseadragon';
import { Options, Options as OpenSeadragonOptions } from 'openseadragon';
import React from 'react';
import { MediaHTMLAttributes, ReactElement, ReactNode } from 'react';
 ...
 * </Viewer.Root>
 */
export declare const Viewer: React.FC<CloverViewerProps> & {
...
declare function createOpenSeadragonRect(canvas: CanvasNormalized, parsedAnnotationTarget: ParsedAnnotationTarget, zoomLevel: number): OpenSeadragon.Rect;
...
export declare const helpers: {
	parseAnnotationTarget: (target: AnnotationTargetExtended | string) => ParsedAnnotationTarget;
	createOpenSeadragonRect: typeof createOpenSeadragonRect;
};
